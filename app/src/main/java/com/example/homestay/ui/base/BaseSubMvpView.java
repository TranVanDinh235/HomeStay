...
public abstract class BaseSubMvpView extends ViewGroup implements SubMvpView {

    private MvpView mParentMvpView;

    public BaseSubMvpView(Context context) {
        super(context);
    }

    public BaseSubMvpView(Context context, AttributeSet attrs) {
        super(context, attrs);
    }

    public BaseSubMvpView(Context context, AttributeSet attrs, int defStyleAttr) {
        super(context, attrs, defStyleAttr);
    }

    @TargetApi(21)
    public BaseSubMvpView(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
